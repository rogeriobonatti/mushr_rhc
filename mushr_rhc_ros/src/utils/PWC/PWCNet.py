...
Extracted from https://github.com/yunyikristy/UPAM/tree/vo/evalVO/PWC
Original version from 
    1. https://github.com/sniklaus/pytorch-pwc
    2. https://github.com/NVlabs/PWC-Net/blob/master/PyTorch/README.md
TODO: Need to double check the difference between extracted version and original version.
"""
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4, flow_norm=20.0):
        ...
        self.upfeat6 = deconv(od+dd[4], 2, kernel_size=4, stride=2, padding=1) # FIXME: Why only keep 2-dim?
    ...
    def forward(self,x):
        ...
        c12 = self.conv2b(self.conv2aa(self.conv2a(c11)))  # 1/4
        c22 = self.conv2b(self.conv2aa(self.conv2a(c21)))
        c13 = self.conv3b(self.conv3aa(self.conv3a(c12)))  # 1/8
        c23 = self.conv3b(self.conv3aa(self.conv3a(c22)))
        c14 = self.conv4b(self.conv4aa(self.conv4a(c13)))  # 1/16
        c24 = self.conv4b(self.conv4aa(self.conv4a(c23)))
        c15 = self.conv5b(self.conv5aa(self.conv5a(c14)))  # 1/32
        ...
        warp5 = self.warp(c25, up_flow6*0.625)  # *20/32
        # corr5 = self.corr(c15, warp5) 
        corr5 = FunctionCorrelation(tenFirst=c15, tenSecond=warp5)  # FIXME: What's the aim of computing correlation between original img1 and warped img2? It is not predicting delta flow anyway.
        corr5 = self.leakyRELU(corr5)
        x = torch.cat((corr5, c15, up_flow6, up_feat6), 1)  # Perhaps the use is to make the corr5 / c15 (?) focus on details and up_flow6 / up_feat6 on general flows. Then together it can give good prediction.
        ...
        x = self.dc_conv4(self.dc_conv3(self.dc_conv2(self.dc_conv1(x))))  # Dilated convolutions at very last for additional large-receptive-field context.
