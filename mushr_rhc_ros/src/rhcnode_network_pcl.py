...
class RHCNode(rhcbase.RHCBase):
    def __init__(self, dtype, params, logger, name):
        ...
        mconf = GPTConfig(vocab_size, block_size, max_timestep,
                      n_layer=6, n_head=8, n_embd=128, model_type='GPT', use_pred_state=True,
                      state_tokenizer='pointnet', train_mode='e2e', pretrained_model_path='', pretrained_encoder_path='', loss='MSE',
        ...
        if self.use_map:
            ...
            saved_map_model_path = '/home/rb/hackathon_data/aml_outputs/log_output/mushr-repro-pointnet-downstream/GPTmap_finetune_nofreeze_pointnet_2022-05-03_1651604865.6388767_2022-05-03_1651604865.6388865/model/epoch29.pth.tar'
            ...
            map_mconf = GPTConfig(vocab_size, block_size, max_timestep,
                          n_layer=6, n_head=8, n_embd=128, model_type='GPT', use_pred_state=True,
                          state_tokenizer='pointnet', train_mode='map', pretrained_model_path='', pretrained_encoder_path='', loss='MSE',
                          map_decoder='deconv', map_recon_dim=64, freeze_core=False)
            map_model = GPTdiff(map_mconf, device)
        ...
        if self.use_loc:
            ...
            saved_loc_model_path = '/home/rb/hackathon_data/aml_outputs/log_output/mushr-repro-pointnet-downstream/GPTloc_1trans1000xangle_finetune_nofreeze_pointnet_2022-05-03_1651604868.6678429_2022-05-03_1651604868.6678524/model/epoch22.pth.tar'
            
            loc_mconf = GPTConfig(vocab_size, block_size, max_timestep,
                          n_layer=6, n_head=8, n_embd=128, model_type='GPT', use_pred_state=True,
                          state_tokenizer='pointnet', train_mode='loc', pretrained_model_path='', pretrained_encoder_path='', loss='MSE',
                          map_decoder='deconv', map_recon_dim=64, freeze_core=False)
            loc_model = GPTdiff(loc_mconf, device)
            # map_model=torch.nn.DataParallel(map_model)
