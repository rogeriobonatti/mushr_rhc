"""
ResNet models modified from https://github.com/TengdaHan/MemDPC/blob/master/backbone/resnet_2d3d.py
"""
import torch
...
class ResNet2d3d_full_C1(nn.Module):
    """ResNet2d3d_full with 1 input channel."""
    def __init__(self, block, layers, track_running_stats=True):
        super(ResNet2d3d_full_C1, self).__init__()
        self.inplanes = 64
        self.track_running_stats = track_running_stats
        bias = False
        self.conv1 = nn.Conv3d(1, 64, kernel_size=(1,7,7), stride=(1, 2, 2), padding=(0, 3, 3), bias=bias)  # Note: The input channels is 2 here.
...
class ResNet2d3d_full_C2(nn.Module):
    """ResNet2d3d_full with 2 input channels."""
    def __init__(self, block, layers, track_running_stats=True):
        super(ResNet2d3d_full_C2, self).__init__()
        self.inplanes = 64
        self.track_running_stats = track_running_stats
        bias = False
        self.conv1 = nn.Conv3d(2, 64, kernel_size=(1,7,7), stride=(1, 2, 2), padding=(0, 3, 3), bias=bias)  # Note: The input channels is 2 here.
...
def resnet18_2d3d_full(**kwargs):
    ...
    model = ResNet2d3d_full([BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d], [2, 2, 2, 2], **kwargs)
    return model

def resnet18_2d3d_full_C1(**kwargs):
    """Constructs a ResNet-18 model with 1 input channel."""
    model = ResNet2d3d_full_C1([BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d], [2, 2, 2, 2], **kwargs)
    return model

def resnet18_2d3d_full_C2(**kwargs):
    """Constructs a ResNet-18 model with 2 input channels."""
    model = ResNet2d3d_full_C2([BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d], [2, 2, 2, 2], **kwargs)
    return model

# ResNet-34 variants.
def resnet34_2d3d_full(**kwargs):
    """Constructs a ResNet-34 model."""
    model = ResNet2d3d_full([BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d], [3, 4, 6, 3], **kwargs)
    return model

# ResNet-50 variants.
def resnet50_2d3d_full(**kwargs):
    """Constructs a ResNet-50 model."""
    model = ResNet2d3d_full([Bottleneck2d, Bottleneck2d, Bottleneck3d, Bottleneck3d], [3, 4, 6, 3], **kwargs)
    return model